 ...
 {isSquare ? (
  ...
  <div className="relative w-full">
    ...
    />
                ...
                <div className="absolute inset-0 bg-brand/85 flex flex-col items-center justify-center gap-4 p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <span className="h-0.5 w-8 rounded-full bg-brand-foreground/70" />
