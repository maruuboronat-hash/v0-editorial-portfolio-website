...
export const metadata: Metadata = {
  ...
  description: 'Portfolio de diseño gráfico y comunicación visual',
  generator: 'v0.app',
  icons: {
    icon: [
      {
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_rpcmZ2w4Fku?ref=3DZF3O"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-c636a2dc-05d8-4ce1-8fce-807e60c6f8ef').style.display='none'"
