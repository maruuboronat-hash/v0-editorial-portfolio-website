...
// ============================================================
//  DATOS DE PROYECTOS (SIN TRADUCCIONES)
// ============================================================
const projectsData: Record<string, {
  ...
  "libro-tecnico-manual": {
    ...
    sections: [
      ...
      { type: "tools", tools: ["InDesign", "Photoshop", "Illustrator"] },
  ...
  "revistas-editorial": {
    ...
    sections: [
      { type: "tools", tools: ["InDesign", "Photoshop", "Illustrator"] },
      { type: "text", title: "Revista - Eduardo Estupía", content: "" },
      { type: "single-column-stack", images: [
      ...
      { type: "text", title: "Revista - Julio Le Parc", content: "" },
      { type: "single-column-stack", images: [
      ...
      { type: "text", title: "Revista - Ariadna Pastorini", content: "" },
      { type: "single-column-stack", images: [
  ...
  "fanzine-infancia": {
    ...
    sections: [
      { type: "tools", tools: ["InDesign", "Photoshop", "Illustrator", "Premiere", "After Effects"] },
      { type: "single-column-stack", images: [
  ...
  "postales-cortazar": {
    ...
    sections: [
      { type: "tools", tools: ["Photoshop", "Illustrator"] },
      { type: "single-column-stack", images: [
  ...
  "afiche-3d-cordoba": {
    ...
    sections: [
      { type: "tools", tools: ["Blender", "Photoshop", "Illustrator"] },
      { type: "single-column-stack", images: [
  ...
  "cuento-infantil-3d": {
    ...
    sections: [
      { type: "tools", tools: ["Blender", "InDesign", "Illustrator", "Photoshop"] },
  ...
  "modelado-3d-objetos": {
    ...
    sections: [
      { type: "tools", tools: ["Blender", "Photoshop"] },
      { type: "single-column-stack", images: [
  ...
  "cantiere-rebranding": {
    title: "Rebranding y Página Web | Cantiere SA",
    category: "Corporativo",
    categorySlug: "corporativo",
    image: "/images/corporativo/cantiere/portada-cantiere.jpg",
    description: "Renovación integral de la identidad de Cantiere, partiendo de una marca existente para construir un sistema visual y comunicacional actualizado y coherente. El proyecto incluyó el desarrollo de un nuevo manual de marca, la renovación completa de su sitio web —cuya última actualización había sido en 2014— y la actualización de su presencia en redes sociales. Actualmente continúo trabajando en la creación y planificación de contenidos para la marca.",
    sections: [
      { type: "tools", tools: ["Illustrator", "Vibe Coding", "Photoshop"] },
      { type: "text", title: "Manual de marca", titleEn: "Brand Guidelines", content: "" },
      { type: "horizontal-gallery", images: [
        { src: "/images/corporativo/cantiere/manual/pagina-40.jpg", alt: "Manual de marca Cantiere 40" },
        { src: "/images/corporativo/cantiere/manual/pagina-42.jpg", alt: "Manual de marca Cantiere 42" },
        { src: "/images/corporativo/cantiere/manual/pagina-43.jpg", alt: "Manual de marca Cantiere 43" },
        { src: "/images/corporativo/cantiere/manual/pagina-44.jpg", alt: "Manual de marca Cantiere 44" },
        { src: "/images/corporativo/cantiere/manual/pagina-45.jpg", alt: "Manual de marca Cantiere 45" },
        { src: "/images/corporativo/cantiere/manual/pagina-47.jpg", alt: "Manual de marca Cantiere 47" },
        { src: "/images/corporativo/cantiere/manual/pagina-48.jpg", alt: "Manual de marca Cantiere 48" },
        { src: "/images/corporativo/cantiere/manual/pagina-49.jpg", alt: "Manual de marca Cantiere 49" },
        { src: "/images/corporativo/cantiere/manual/pagina-50.jpg", alt: "Manual de marca Cantiere 50" },
        { src: "/images/corporativo/cantiere/manual/pagina-51.jpg", alt: "Manual de marca Cantiere 51" },
        { src: "/images/corporativo/cantiere/manual/pagina-52.jpg", alt: "Manual de marca Cantiere 52" },
        { src: "/images/corporativo/cantiere/manual/pagina-53.jpg", alt: "Manual de marca Cantiere 53" },
        { src: "/images/corporativo/cantiere/manual/pagina-54.jpg", alt: "Manual de marca Cantiere 54" },
        { src: "/images/corporativo/cantiere/manual/pagina-55.jpg", alt: "Manual de marca Cantiere 55" },
        { src: "/images/corporativo/cantiere/manual/pagina-56.jpg", alt: "Manual de marca Cantiere 56" },
        { src: "/images/corporativo/cantiere/manual/pagina-57.jpg", alt: "Manual de marca Cantiere 57" },
        { src: "/images/corporativo/cantiere/manual/pagina-58.jpg", alt: "Manual de marca Cantiere 58" },
        { src: "/images/corporativo/cantiere/manual/pagina-59.jpg", alt: "Manual de marca Cantiere 59" },
        { src: "/images/corporativo/cantiere/manual/pagina-61.jpg", alt: "Manual de marca Cantiere 61" },
        { src: "/images/corporativo/cantiere/manual/pagina-63.jpg", alt: "Manual de marca Cantiere 63" },
        { src: "/images/corporativo/cantiere/manual/pagina-64.jpg", alt: "Manual de marca Cantiere 64" },
        { src: "/images/corporativo/cantiere/manual/pagina-65.jpg", alt: "Manual de marca Cantiere 65" },
        { src: "/images/corporativo/cantiere/manual/pagina-66.jpg", alt: "Manual de marca Cantiere 66" },
        { src: "/images/corporativo/cantiere/manual/pagina-67.jpg", alt: "Manual de marca Cantiere 67" },
        { src: "/images/corporativo/cantiere/manual/pagina-68.jpg", alt: "Manual de marca Cantiere 68" },
      ]},
      { type: "text", title: "Página web", titleEn: "Website", content: "Renovación completa del sitio web de Cantiere.\n\n<a href='https://www.cantieresa.com' target='_blank' rel='noopener noreferrer' class='group inline-flex items-center gap-2 mt-2 rounded-full bg-brand px-5 py-2.5 text-xs uppercase tracking-widest text-brand-foreground transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg'>Ver la página completa <span class='transition-transform duration-300 group-hover:translate-x-1'>&rarr;</span></a>", contentEn: "Complete redesign of Cantiere's website.\n\n<a href='https://www.cantieresa.com' target='_blank' rel='noopener noreferrer' class='group inline-flex items-center gap-2 mt-2 rounded-full bg-brand px-5 py-2.5 text-xs uppercase tracking-widest text-brand-foreground transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg'>View full website <span class='transition-transform duration-300 group-hover:translate-x-1'>&rarr;</span></a>" },
      { type: "two-column-grid", images: [
        { src: "/images/corporativo/cantiere/mockup-1.png", alt: "Sitio web Cantiere - mockup 1" },
        { src: "/images/corporativo/cantiere/mockup-2.png", alt: "Sitio web Cantiere - mockup 2" },
      ]},
    ]
  },
  "power-bi-picklog": {
    ...
    description: "Proyecto desarrollado para la empresa de logística Pick&Log, enfocado en el diseño de plantillas visuales y dashboards para Power BI dentro de su sistema de gestión logística. El trabajo integró diseño funcional y visualización de datos, con el objetivo de optimizar la lectura de información y facilitar el seguimiento de indicadores operativos.",
    sections: [
      { type: "tools", tools: ["Illustrator", "PowerBi"] },
      { type: "infinite-carousel", images: [
  ...
  "coleccion-portuguese": {
    ...
    sections: [
      { type: "tools", tools: ["Photoshop", "Illustrator", "Procreate"] },
      { type: "single-column-stack", images: [
  ...
  "video-casamiento-1995": {
    ...
    sections: [
      { type: "tools", tools: ["Premiere"] },
      { type: "video-embed", src: "/images/proyectos-personales/video-casamiento/casamiento.mp4", caption: "Video de casamiento y luna de miel, 1995" },
    ],
  },
  ...
  "portfolio-video": {
    ...
    sections: [
      { type: "tools", tools: ["AfterEffects", "Premiere", "Blender", "Illustrator"] },
      { type: "video-embed", src: "/images/edicion-video/video-portfolio.mp4", caption: "Portfolio - Diseño IV" }
    ]
  },
  "mini-skirts-video": {
    ...
    sections: [
      { type: "tools", tools: ["Premiere"] },
      { type: "video-embed", src: "https://www.youtube.com/embed/w0SAl3TPjGM", caption: "Mini Skirts - Mary Quant" }
    ]
  },
  "animated-teaser": {
    ...
    sections: [
      { type: "tools", tools: ["After Effects", "Premiere", "Illustrator"] },
      { type: "video-embed", src: "https://www.youtube.com/embed/40SYT5-lHWY", caption: "Animated Teaser - Clavis" }
    ]
  },
  "vlog-diario-video": {
    title: "Vlog Diario",
    ...
    sections: [
      { type: "tools", tools: ["Premiere"] },
      { type: "video-embed", src: "https://www.youtube.com/embed/FlTDpF_Dr6Y", caption: "Vlog Diario" }
    ]
  },
  "motocross-video": {
    title: "Motocross",
    ...
    sections: [
      { type: "tools", tools: ["Premiere"] },
      { type: "video-embed", src: "https://www.youtube.com/embed/mm8RTJ4UoPE", caption: "Motocross" }
    ]
  },
  "indumentaria-video": {
    title: "Indumentaria",
...
export default function ProjectPage() {
  ...
  const descripcionTraducida = t.proyectos_detalle?.[id]?.descripcion || project.description || ""
  
  const categoryKey = categorySlugToKey[project.categorySlug] || "diseno_grafico"
  const categoriaTraducida = t.categorias[categoryKey as keyof typeof t.categorias]?.titulo || project.category
    ...
    <article className="pt-24 pb-24 min-h-screen">
      ...
      <header className="px-6 md:px-12 mb-2 md:mb-24">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <span className="transition-transform duration-300 group-hover:-translate-x-1">&larr;</span> {t.volver_a} {categoriaTraducida}
          </Link>
